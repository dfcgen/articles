// -*- scilab -*-
// $Id: sn3d_real_contour.sci,v 1.1 2004-09-27 19:55:08 ralf Exp $
//
// Scilab plot of real(sn(z;k)) for complex arguments with countour
//
filename="sn3d_real_contour.fig";
...
contour(x, y, z, [0.5, 1, 1/k, 2], theta, alpha, '@@', [1, 1, 0],  rect, -1.0);
